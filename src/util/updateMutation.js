export default function updateMutation(
  ...
  if (mutationAfterChange) {
    return { ...mutation, offset: mutation.offset + lengthDiff }
  }
  ...
  if (mutationContainsChange) {
    return { ...mutation, length: mutation.length + lengthDiff }
  }
  ...
  if (mutationWithinPrefixChange) {
    return { ...mutation, offset: mutation.offset + prefixLength }
  }
  ...
  if (mutationContainsPrefix) {
    return [
      { ...mutation, length: originalOffset - mutation.offset },
      {
        ...mutation,
